...
// Frontier
use fintra_runtime::{AccountId, Balance, SS58Prefix, Signature, WASM_BINARY};
...
pub fn development_config(enable_manual_seal: bool) -> ChainSpec {
	ChainSpec::builder(WASM_BINARY.expect("WASM not available"), Default::default())
		...
		.with_genesis_config_patch(testnet_genesis(
			...
			//AccountId::from(H160::from(hex!("f24FF3a9CF04c71Dbc94D0b566f7A27B94566cac"))),
			// Pre-funded accounts
			vec![
				get_account_id_from_seed::<sr25519::Public>("Alice"),
				...
				get_account_id_from_seed::<sr25519::Public>("Ferdie//stash"),// Faith
			],
