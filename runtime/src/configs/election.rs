use crate::{
	...
	RuntimeBlockLength, RuntimeBlockWeights,RuntimeCall, StakingUnsignedPriority,AccountId,Balances,
	RuntimeEvent,Staking,TransactionPayment,Runtime,Timestamp,UncheckedExtrinsic
};
use frame_election_provider_support::{bounds::{ElectionBounds, ElectionBoundsBuilder},onchain, BalancingConfig, ElectionDataProvider, SequentialPhragmen, VoteWeight,};
use frame_support::{
...
use alloc::vec;
use crate::configs::staking::OffchainRepeat;
use codec::Decode;
use sp_std::prelude::*;
...
// Add CreateTransactionBase implementation for pallet_election_provider_multi_phase::Call<Runtime>
impl frame_system::offchain::CreateTransactionBase<pallet_election_provider_multi_phase::Call<Runtime>> for Runtime {
	type Extrinsic = UncheckedExtrinsic;
	type RuntimeCall = pallet_election_provider_multi_phase::Call<Runtime>;
}
