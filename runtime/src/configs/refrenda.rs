use crate::{
	...
	AccountId, Preimage, Runtime, RuntimeCall, RuntimeEvent, RuntimeOrigin, Scheduler,
	BlockNumber, Balance,
};
...
impl pallet_referenda::TracksInfo<Balance, BlockNumber> for TracksInfo {
	...
	fn tracks() -> impl Iterator<Item = Cow<'static, pallet_referenda::Track<Self::Id, Balance, BlockNumber>>> {
		let root = Cow::Owned(pallet_referenda::Track::<Self::Id, Balance, BlockNumber, 25> {
			id: 0,
		...
		Box::new(vec![root].into_iter()) as Box<dyn Iterator<Item = Cow<'static, pallet_referenda::Track<Self::Id, Balance, BlockNumber>>>>
	}
